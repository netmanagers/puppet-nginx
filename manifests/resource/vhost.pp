...
#   [*disable_default*]  - BOOL value that dictates whether the "default" configuration file that is normally
#                          present after installation of nginx should be disabled
#
# Actions:
#
# Requires:
